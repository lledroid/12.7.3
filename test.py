#создаю поле для ввода инвестируемой суммы
...
pro_cent = list(per_cent.values())
#записываю доход в каждом банке в переменные и округляю
bankTKB = round(pro_cent[0]/100*money)
bankCKB = round(pro_cent[1]/100*money)
bankVTB = round(pro_cent[2]/100*money)
bankSBER = round(pro_cent[3]/100*money)
